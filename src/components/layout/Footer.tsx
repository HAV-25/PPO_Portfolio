    ...
    <footer className="border-t border-rule bg-cream mt-auto">
      <div className="content-width py-12 md:py-14">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10">
          ...
          <div className="max-w-xs">
            ...
            <div className="flex items-center gap-4 mt-4 flex-wrap">
              <a
                ...
                className="font-jakarta text-[13px] text-navy hover:opacity-70 transition-opacity flex items-center gap-1.5"
                aria-label="Payal Ponkshe on LinkedIn"
              >
              ...
              <a
                href="mailto:payalponkshe@gmail.com"
                className="font-jakarta text-[13px] text-navy hover:opacity-70 transition-opacity"
              >
                payalponkshe@gmail.com
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-8 sm:gap-14">
            ...
            <div>
              ...
              <ul className="flex flex-col gap-2.5">
                <li><Link href="/book" className="font-jakarta text-[14px] text-slate hover:text-navy transition-colors">Book a call</Link></li>
                <li><Link href="/give-back" className="font-jakarta text-[14px] text-slate hover:text-navy transition-colors">Give back</Link></li>
                <li><Link href="/causes" className="font-jakarta text-[14px] text-slate hover:text-navy transition-colors">Causes</Link></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-10 pt-6 border-t border-rule gap-3">
          <p className="font-jakarta text-slate text-[12px]">
            © 2026 Payal Ponkshe. All rights reserved.
          </p>
          <span
            className="font-jakarta font-bold text-navy text-[13px] tracking-tight"
            aria-hidden="true"
          >
            PP
          </span>
